...
In this paper, the theory of grey systems is used as a predictive model, which makes it possible to obtain an adequate model that uses a small number of initial samples of real temperature data. Based on the grey model GMC(1,n) a new optimal model was presented, which is constructed by using optimization algorithm. Optimal model predicts the BTP, and if it does not match the set value or to find out an optimal regulation, a control synthesis is carried out through an optimization of the prediction according to the “particle swarm” algorithm.}
...
\begin{figure}[htbp]
	\centering
	\resizebox*{10 cm}{!}{
		\includegraphics{TempCurves.eps}}
...
\begin{figure}[htbp]
	\centering
	\resizebox*{10 cm}{!}{
		\includegraphics{VelocCurves.eps}}
...
\begin{figure}[t]
	\centering
	\resizebox*{12 cm}{!}{
		\includegraphics{GMCVSFGMCVSODGMC1.eps}}
...
\begin{figure}
	...
	\begin{subfigure}{.5\textwidth}
		\centering
		\includegraphics[width=1\linewidth]{ControlResults1.eps}
	\end{subfigure}%
	\begin{subfigure}{.5\textwidth}
		\centering
		\includegraphics[width=1\linewidth]{ControlResults2.eps}
	\end{subfigure}
	\begin{subfigure}{.5\textwidth}
	\centering
	\includegraphics[width=1\linewidth]{ControlResults3.eps}
	\end{subfigure}
